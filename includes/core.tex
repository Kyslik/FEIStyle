\section{Úkážka skratiek}
\noindent Verzia FEIstyle 1.3 používa acronym\footnote{\url{https://www.ctan.org/pkg/acronym?lang=en}} balík.
\acf{IC} je dlhá skratka naopak \acs{TDMA} je skratka v krátkej forme.
\section{Recitácia}
Citujem všetky zdroje v \textbf{bibliography.tex}, \cite{t00, t01, t02, t03, kniha, kniha2, kniha3, small, big, cs, koll, kap, tug, knuth, zbornik, prispevok}. \newline Good luck.
...
\noindent Najpoužívanejšie internetové prehliadače súčasnosti majú v sebe zabudovanú funkcionalitu, ktorá dokáže čiastočne anonymizovať prístup na internet. Táto funkcionalita blokuje ukladanie navštívených stránok do histórie a nezaznamenáva súbory, ktoré sa stiahnu z~internetu. \ac{SW} a \acl{HW} sú skratky.
