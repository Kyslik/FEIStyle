...
FEIstyle, verzia 3.0.0. Príručka je po formálnej a vizuálnej stránke navrhnutá tak,
...
Šablóna je v aktuálnej verzii rozdelená do dvoch častí.
Prvá, trieda \verb|FEIstyle.cls|, obsahuje definície rozmerov, okrajov,
číslovania strán, štýlov nadpisov a iné podobné nastavenia týkajúce sa vzhľadu
dokumentu.
Druhá, balík \verb|FEIstylethesis.sty|, obsahuje množstvo makier a príkazov na
generovanie zoznamov obrázkov, tabuliek a iných základných častí záverečnej práce.
