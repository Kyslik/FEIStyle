...
V zdrojovom kóde umiestňujeme príkazy na sadzbu obrázka za odsek,
...
poradové číslo obrázka v práci.
...
Umiestnenie obrázka v rámci dokumentu riadi pomerne
...
Pomôže zmena rozmerov obrázka, prípadne jeho premiestnenie inam v zdrojovom kóde.
...
\subsection{Označenie obrázka a text pod obrázkom}
Text pod obrázkom pozostáva z~označenia obrázka a z~vysvetľujúceho obsahu.
Mal by sa nachádzať spolu s~obrázkom na tej istej strane.

Text je dostatočne opisný,
aby bol jasný obsah obrázka aj pri rýchlom prechádzaní
...
Odvolávanie sa na číslo obrázka rieši dvojica príkazov \verb|\label| a~\verb|\ref|.
...
Znamená to, že ak predpokladáme veľkosť obrázka
