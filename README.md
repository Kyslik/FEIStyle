...
This version is currently in development, but is getting stable towards release.
You can use it already, but expect some rough edges.
The release is planned in september 2026.
...
Upgraded FEIStyle:
 ...
 - support for citation standard [ISO-690](https://github.com/michal-h21/biblatex-iso690) required by [STU FEI](https://www.fei.stuba.sk/dokumenty/docs/kniznica/2023-2024/Nove_pravidla_citovania.pdf), using biber
 - support for glossaries package
 - removed FEIstyle.bst (not needed)
 - added Makefile
 - improved contents of project file structure
